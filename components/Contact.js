...
export default function Contact() {
  return (
    <Section reverseBg={true} id="contact">
      ...
      <div className="mt-16 grid lg:grid-cols-2 items-start justify-items-end">
        {/* <ContactForm /> */}
        <div className="flex flex-col gap-y-10">
          ...
          <a
            ...
            className="flex items-center justify-center cursor-pointer text-xl h-[50px] w-60 bg-white rounded text-black"
          >
            Say Hello
          </a>
        </div>
