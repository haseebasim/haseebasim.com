export const ProjectsData = [
  {
    img: '/images/mariee-anne.png',
    title: 'Marie-Ann Derville',
    description:
      'A portfolio website for one of my clients. She is an architect based out of France.',
    technologies: ['Next Js', 'ContentFul', 'GraphQl', 'Tailwind CSS'],
    preview: 'https://www.marieannederville.com/',
    github: ''
  },
  {
    img: '/images/machinery-planet.png',
    title: 'Machinery Planet',
    description:
      'Front-end for an e-commerce platform that sells different machines and machine parts for construction industry in Dubai.',
    technologies: ['React, Material UI'],
    preview: 'https://machinery-planet.vercel.app/',
    github: 'https://github.com/haseebasim/Machinery-Planet'
  },
  {
    img: '/images/toronto-underground.png',
    title: 'Toronto Underground',
    description:
      'Toronto Underground is an application where users can view various listings regarding auctions happening in Canada.',
    technologies: ['Next Js', 'Next Auth', 'Stripe', 'Tailwind CSS'],
    preview: 'https://toronto-underground.vercel.app/',
    github: ''
  }
];
